...
for k in tickerdict:
    select_query = 'SELECT ticker FROM database_name WHERE ticker=\''+str(k)+'\''
    tik = k
    k = tickerdict[k]
    k[0] = tik
    print(k)
